...
public class CreateAccountCommand extends LeafCommand {
    public CreateAccountCommand(AccountService accountService, UserDao dao, ChannelMessageSenderImpl messageSender) {
        super(new AbstractCommand() {
            ...
            public void execute(GuildChannel channel, User sender, String... args) {
                ...
                accountService.createAccount(sender.getIdLong());
            }
        });
    }
}
